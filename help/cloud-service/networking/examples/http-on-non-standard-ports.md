---
title: HTTP/HTTPS connections on non-standard ports
description: Learn how to make HTTP/HTTPS requests from AEM as a Cloud Service to external web services running on non-standard ports.
