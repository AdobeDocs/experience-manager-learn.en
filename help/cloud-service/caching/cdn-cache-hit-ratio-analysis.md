...
1. For a desired AEMCS environment, select **Download Logs** from the ellipsis menu.
    ...
    ![Download Logs - Cloud Manager](assets/cdn-logs-analysis/download-logs.png){width="200" zoomable="yes"}
...
1. In the **Download Logs** dialog, select the **Publish** Service from the drop-down menu, then click the download icon next to the **cdn** row.
    ...
    ![CDN Logs - Cloud Manager](assets/cdn-logs-analysis/download-cdn-logs.png){width="200" zoomable="yes"}
...
1. To identify the CDN cache hit ratio and top URLs, follow these steps:
    ...
    1. Select the desired time range from the top-right corner.
        ...
        ![Time Range - Kibana Dashboard](assets/cdn-logs-analysis/time-range.png){width="200" zoomable="yes"}
    ...
    1. The _Total Request Analysis_ section displays the following details:
        ...
        ![Total Request Analysis - Kibana Dashboard](assets/cdn-logs-analysis/total-request-analysis.png){width="200" zoomable="yes"}
    ...
    1. The _Analysis by Request or Mime Types_ displays the following details: 
        ...
        ![Analysis by Request or Mime Types - Kibana Dashboard](assets/cdn-logs-analysis/analysis-by-request-or-mime-types.png){width="200" zoomable="yes"}
...
1. In the **Add filter** modal, select the `aem_env_name.keyword` field from the drop-down menu, and `is` operator and desired environment name for next field and finally click _Add filter_.
    ...
    ![Add Filter - Kibana Dashboard](assets/cdn-logs-analysis/add-filter.png){width="200" zoomable="yes"}
...
- **Load CDN Log File**: loads the CDN log file using `log_file` variable value, make sure to update its value. It also transforms this CDN log into the [Pandas DataFrame](https://pandas.pydata.org/docs/reference/frame.html).
...
1. In the Adobe Experience Platform Home page > Data Science section >, click the **Notebooks** menu item. To start the Jupyter Notebooks environment, click the **JupyterLab** tab. 
    ...
    ![Notebook Log File Value Update](assets/cdn-logs-analysis/datascience-notebook.png){width="200" zoomable="yes"}
...
1. In the JupyterLab menu, using the **Upload Files** icon, upload the downloaded CDN log file and `aemcs_cdn_logs_analysis.ipynb` file.
    ...
    ![Upload Files - JupyteLab](assets/cdn-logs-analysis/jupyterlab-upload-file.png){width="200" zoomable="yes"}
...
1. In the **Load CDN Log File** section of the notebook, update the `log_file` value.
    ...
    ![Notebook Log File Value Update](assets/cdn-logs-analysis/notebook-update-variable.png){width="200" zoomable="yes"}

1. To run the selected cell and advance, click the **Play** icon. 
    
    ![Notebook Log File Value Update](assets/cdn-logs-analysis/notebook-run-cell.png){width="200" zoomable="yes"}
...
1. After running the **Display Analysis Result for Total, HTML, JS/CSS, and Image Requests** code cell, the output displays the cache hit ratio percentage, bar, and pie charts.
    ...
    ![Notebook Log File Value Update](assets/cdn-logs-analysis/output-cache-hit-ratio.png){width="200" zoomable="yes"}
...
1. After running the **Top 5 MISS and PASS Request URLs for HTML, JS/CSS, and Image** code cell, the output displays the Top 5 MISS and PASS Request URLs.
    ...
    ![Notebook Log File Value Update](assets/cdn-logs-analysis/output-top-urls.png){width="200" zoomable="yes"}
