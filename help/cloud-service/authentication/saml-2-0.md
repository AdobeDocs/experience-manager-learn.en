...
duration: 2200
TQID: https://experienceleague.adobe.com/HqqeUXCem2pwD4X2Nstf7sjp5by4fxDFdl-hXbkgLXo
product_v2:
...
Instead, use [environment-specific configuration values](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/deploying/configuring-osgi#environment-specific-configuration-values) within your OSGi configurations, and [set the appropriate variable values](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/deploying/configuring-osgi#cloud-manager-api-format-for-setting-properties) for the Preview and Publish environments.
...
## Custom SAML login hooks

For advanced used cases, AEM supports the development of custom SAML login hooks, which are OSGi services implementing the `com.adobe.granite.auth.saml.SamlLoginHook` interface. These hooks are executed during the SAML authentication process, and they can be used to implement custom logic, such as additional user provisioning or custom logging.

For more information on how to develop and register a custom SAML login hook, please refer to the [Custom SAML Login Hook](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/custom-saml-login-hook.html) documentation.
