...
| [Filter requests for response transformation](./how-to/request-filtering.md) | Transform responses at the edge by intercepting broader request sets at the CDN |
