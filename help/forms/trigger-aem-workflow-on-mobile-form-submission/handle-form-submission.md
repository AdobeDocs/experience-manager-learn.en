---
title: Trigger AEM workflow on HTML5 Form Submission
description: Handle the HTML5 form submission
...
TQID: 'https://experienceleague.adobe.com/BmKyRG-mn9FP4eQKbHMrXHFrym3ZrdaZx7fQriHMnBU'
product_v2:
...
In this part we will create a simple servlet that runs on AEM Publish to handle the HTML5 form submission. This servlet, makes an HTTP POST request to a servlet running in an AEM author instance responsible for saving the submitted data as a `nt:file` node in AEM Author's repository.

The following is the code of the servlet which handles the HTML5 form submission. In this servlet we make a POST call to a servlet mounted on **/bin/startworkflow** in a AEM Author instance. This servlet saves the form data in the AEM Author's repository.


## AEM Publish servlet

The following code handles the HTML5 form submission. This code runs on the publish instance.
