...
duration: 75
TQID: 'https://experienceleague.adobe.com/pNiL3mK-bITYL573smSI0fl10dfPboTGFZwQr331rWI'
product_v2:
...
A custom process step was implemented to create the zip file containing the form attachments. If you are not familiar with creating an OSGi bundle, please [follow these instructions](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/create-your-first-osgi-bundle.html?lang=en).

The code in the custom process step does the following:

- Query for all the adaptive form attachments under the payload folder. The folder name is passed as a process argument to the process step.
- Create a zip file containing the form attachments and store it under the payload folder.
- Set the value of the workflow variable (no_of_attachments).
...
>[!NOTE]
>
> Please ensure you have a variable called _no_of_attachments_ of type Double in your workflow for this code to work.
