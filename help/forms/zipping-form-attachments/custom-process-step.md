...
* Create a zip file and add the form attachments to the zip file.
* Set the value of 2 workflow variables (attachments_zip and no_of_attachments)
...
>[!NOTE]
>
> Please make sure you have a variable called *attachments_zip* of type document and *no_of_attachments* of type Double in your workflow for this code to work
