...
* You will need to create a property of type String called assettypes(you can name it as per your requirement) with multivalue. Provide the values that you want and save.
