---
title: Asset Insights and Reports
description: Learn how to view asset activity in the Insights dashboard and build custom reports in AEM Assets, in both the Assets view and Admin view.
solution: Experience Manager, Experience Manager Assets
sub-product: Experience Manager Assets
version: Experience Manager 6.4, Experience Manager 6.5, Experience Manager as a Cloud Service
feature-set: Experience Manager Assets
feature: Asset Insights
topic: Content Management, Administration
...
jira: TODO
TQID: 'https://experienceleague.adobe.com/7-e0nLwolpJvVd9jb-2VM7jmwMUVZbIoVDEzCDlpUBg'
product_v2:
...
>[!IMPORTANT]
>
>AEM 6.5 lets administrators configure [asset reports](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/administer/asset-reports#prerequisite-for-reporting) and choose what to track and include.
