...
+ Authoring{#authoring}
  ...
  + [Extract archive](./authoring/extract-archive.md)
  + [Metadata](./authoring/metadata.md)
  + [Renditions](./authoring/renditions.md)
  + [Processing profiles](./authoring/processing-profiles.md)
  + [Relate and unrelate](./authoring/relate-unrelate.md)

+ Collaboration{#collaboration}
  + [Watch](./collaboration/watch.md)
  + [Comments, annotations, and tasks](./collaboration/comments-annotations-and-tasks.md)
  + [Customizing annotations PDF output](./collaboration/customizing-annotations-pdf-output.md)
...
+ Search and discovery{#search-and-discovery}
  ...
  + [My Workspace and quick access](./search-and-discovery/my-workspace.md)
  + [Assets admin search rail](./search-and-discovery/assets-admin-search-rail.md)
...
+ Metadata & taxonomy{#metadata}
  ...
  + [Cascading metadata](metadata/cascade-metadata.md)
...
+ Asset distribution{#asset-distribution}
  + Sharing and activation{#sharing}
    + [Link sharing](./sharing/link-sharing.md)
  ...
  + Content Hub{#content-hub}
    ...
    + [Manage assets use case](./content-hub/use-cases/manage-assets.md)

  + Asset Share Commons{#assets-share}
    + [Understand the user experience](./sharing/asset-share-commons-user-experience-feature-video-understand.md)
...
+ Integrations{#integrations}
  ...
  + Adobe Asset Link{#adobe-asset-link}
    ...
    + [Authentication](./adobe-asset-link/authentication.md)
  ...
  + Workfront{#workfront}
    ...
    + Assets view connector{#assets-view-connector}
      + [Overview](./workfront/assets-view-connector/overview.md)
      + [Configure](./workfront/assets-view-connector/configure.md)
      + [Map metadata](./workfront/assets-view-connector/map-metadata.md)
      + [Send documents and link assets](./workfront/assets-view-connector/link-send.md)
      + [Version history](./workfront/assets-view-connector/versions.md)
...
+ Automation{#automation}
  + [Content automation overview](./content-automation/overview.md)
  ...
  + [InDesign files and Asset Templates](./asset-templates/asset-templates-tutorial-understand.md)
  + [Asset Templates with InDesign Server](./asset-templates/asset-templates-feature-video-use.md)
  + [Set up Asset Templates with InDesign Server](./asset-templates/asset-templates-technical-video-setup.md)
  + [Asset Catalogs with InDesign Server](./asset-templates/asset-catalog-template-feature-video-use.md)
...
+ Dynamic Media{#dynamic-media}
  ...
  + Images {#images}
    ...
    + [Watermarks](dynamic-media/dynamic-media-watermarks.md)
  + Video {#video}
    ...
    + [Video closed captions](dynamic-media/dynamic-media-video-closed-captions.md)
  + Viewers {#viewers} 
  ...
  + 3D {#3d}
    ...
    + [3D assets](dynamic-media/dynamic-media-3d-assets.md)
...
+ Developer and APIs{#developer}
  + [Programmatic asset upload](./developer/programmatic-asset-upload.md)
  + [Multi-tenancy and concurrent development](./developer/multitenancy-concurrent-development.md)
  + [Provisioning](./developer/provisioning.md)
