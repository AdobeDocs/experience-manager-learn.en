...
duration: 228
TQID: 'https://experienceleague.adobe.com/LziJKsGdISofwo1VkF8grEmEDw9EeNhZT6mg8fOWO-o'
product_v2:
...
1.  Tap **Create** in the top-right corner to bring up the **Create Model** wizard.
1.  In **Model Title** field, enter **Person** and tap **Create**. In the resulting dialog, tap **Open**, to build the model.
...
1.  Add several **Options** using the **Add an option** button. Use the same value for **Option Label** and **Option Value**:
...
1.  In **Model Title** field, enter **Team** and tap **Create**.
...
In the next chapter, [Authoring Content Fragment Models](author-content-fragments.md), you create and edit a new Content Fragment based on a Content Fragment Model. You also learn how to create variations of Content Fragments.
