...
+ Code Samples {#code-samples}
  + {hide-from-toc} [Filtering React app](./graphql/code-samples/filtering-react-app.md)
  + {hide-from-toc} [Filtering Preact app](./graphql/code-samples/filtering-preact-app.md)
  + {hide-from-toc} [Filtering Angular app](./graphql/code-samples/filtering-angular-app.md)
  + {hide-from-toc} [Filtering Vue app](./graphql/code-samples/filtering-vue-app.md)
  + {hide-from-toc} [Filtering with jQuery and Handlebars](./graphql/code-samples/filtering-jquery-handlebars.md)
  + {hide-from-toc} [Filtering SvelteKit app](./graphql/code-samples/filtering-sveltekit-app.md)
  + {hide-from-toc} [Filtering ExpressJS and Pug app](./graphql/code-samples/filtering-express-pug-app.md)
  + {hide-from-toc} [Basic React app](./graphql/code-samples/basic-react-app.md)
  + {hide-from-toc} [Basic Next.js app](./graphql/code-samples/basic-nextjs-app.md)
