---
title: Use the SSL Wizard
seo-title: Use the SSL Wizard in AEM
...
targetaudience: target-audience upgrader;target-audience advanced
index: y
internal: n
snippet: y
---
...
The above video depicts the setup and configuration of SSL on an AEM author instance using self-signed certificates. The below commands using [OpenSSL](https://www.openssl.org/) can generate a private key and certificate to be used in Step 2 of the wizard.
