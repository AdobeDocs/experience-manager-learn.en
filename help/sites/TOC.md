...
+ Document Authoring {#document-authoring}
  ...
  + How to{#how-to}
    ...
    + [Target audiences for Generate Variation](./document-authoring/how-to/using-target-audiences-in-generate-variations.md)
    + [Audiences CSV file for Generate Variation](./document-authoring/how-to/using-audiences-csv-file-in-generate-variations.md)
    + [Adobe Firefly for Generate Variation](./document-authoring/how-to/using-adobe-firefly-for-images-in-generate-variations.md)
