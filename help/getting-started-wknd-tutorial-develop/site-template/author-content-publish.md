---
title: Author content and publish changes
...
1. Under **Scope**, select the **WKND Site** and click **Include Children**. In the dialog, un-check all of the boxes. We want to publish the full site.

    ![Update publish scope](assets/author-content-publish/update-scope-publish.png)

1. Click the **Published References** button. In the dialog, verify that everything is checked. This will include the **Basic AEM Site Template** and several configurations generated by the Site Template. Click **Done** to update.

    ![Publish references](assets/author-content-publish/publish-references.png)

1. Finally, click **Publish** in the upper right-hand corner to publish the content.
